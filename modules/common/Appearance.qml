...
Singleton {
    ...
    sizes: QtObject {
        ...
        property real islandHeight: Config.options.island.cornerStyle === 1 ? 
            (baseBarHeight + root.sizes.hyprlandGapsOut * 2) : baseBarHeight
        property real barCenterSideModuleWidth: Config.options?.island.verbose ? 360 : 140
        ...
        property real verticalBarWidth: Config.options.island.cornerStyle === 1 ? 
